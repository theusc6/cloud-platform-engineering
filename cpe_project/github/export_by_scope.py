...
QUERY_ALERTS = """
query($owner: String!, $name: String!, $scope: String!) {
  repository(owner: $owner, name: $name) {
    vulnerabilityAlerts(first: 100, filterBy: {dependencyGraphDependencyScope: $scope) {
      edges {
        node {
          id
...
for repo in ALL_REPOS:
    ...
    if response.status_code == 200:
        ...
        for alert in vulnerability_alerts:
            ...
            scope_matches = re.search(r'"scope"\s*:\s*"([^"]+)"',
            ...
            alert_data = {
                ...
                "vulnerableRequirements": vulnerable_requirements,
                ...
                "dependency_scope": scope  # Set the scope variable based on the requirements
            }
