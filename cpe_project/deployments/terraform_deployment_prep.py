...
def create_github_actions_role(session, account_id, region):
    ...
    role_name = f'role-myorg-terraform_github_actions-{account_id}-{region}'
        ...
        "Statement": [
            {
                "Effect": "Allow",
                "Principal": {
                    "AWS": ["arn:aws:iam::123456789012:role/Terraform_github_actions"]
                },
...
def main():
    ...
    if args.create_s3:
        ...
        bucket_name = f'myorg-terraform-state-{args.project_name}-{args.account_id}-{args.region}'
    ...
    if args.create_dynamodb:
        ...
        table_name = f'myorg-terraform-lock-{args.project_name}-{args.account_id}-{args.region}'
